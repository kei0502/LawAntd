...
const CreditorDispatch = React.createClass({
    getInitialState(){
    ...
    render(){
        ...
        return (<div>
            ...
            <Row>
                <Col span={4}><SiderCreditor current="user_menu7"/></Col>
                <Col span={20}>
...
ReactDOM.render(<CreditorDispatch dispatches={mock.dispatches}/>, document.getElementById('react-content'));