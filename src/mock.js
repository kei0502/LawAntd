...
module.exports = {
  ...
  dispatches: [{_id: "501", name: "文件1", file: "/processv1.pdf", company: {_id: "111", name: "中国移动"}}, {
    ...
    company: {_id: "112", name: "中国电信"}
      ...
      name: "文件2",
      file: "/processv1.pdf",
      company: {_id: "111", name: "中国移动"},
      response: {style: 2, text: "同意"}
  },{
      _id: "515",
      name: "文件1",
      file: "/processv1.pdf",
  ...
  users:[{_id: '1',name:'中国移动',role:1},
    {_id: '2',name:'管理人1',role:2},
    {_id: '3',name:'工作人员1',role:3},
    {_id: '4',name:'法院1',role:4},
    {_id: '5',name:'平台管理员1',role:5},
    {_id: '6',name:'债务公司1',role:6},
    {_id: '7',name:'审计师1',role:7}],
  platform: {name: "王五", role: 5},
  files:[{_id:'1',name:'公司年报',file:'/processv1.pdf',status:1,date:'2016-02-21',company:{_id:1,name:'中国移动'}},
    {_id:'2',name:'公司报告',file:'/processv1.pdf',status:1,date:'2016-02-22',company:{_id:2,name:'中国电信'}},
    {_id:'3',name:'会议公告',file:'/processv1.pdf',status:2,date:'2016-02-23',company:{_id:1,name:'中国移动'}},
    {_id:'4',name:'会议公告',file:'/processv1.pdf',status:1,date:'2016-03-01',company:{_id:1,name:'中国移动'}},
    {_id:'5',name:'公司年报',file:'/processv1.pdf',date:'2016-03-11',company:{_id:1,name:'中国移动'}},
    {_id:'6',name:'会议线下文件公示',file:'/processv1.pdf',status:1,date:'2016-03-22',company:{_id:2,name:'中国电信'}},
    {_id:'7',name:'会议结果公示',file:'/processv1.pdf',date:'2016-04-14',company:{_id:2,name:'中国电信'}},
    {_id:'8',name:'分配清算结果公示',file:'/processv1.pdf',status:1,date:'2016-05-08',company:{_id:2,name:'中国电信'}},
    {_id:'9',name:'公司年报',file:'/processv1.pdf',status:2,date:'2016-06-15',company:{_id:1,name:'中国移动'}}],
  advertisements:[{_id:1,name:'张三',contact:'13333333333',description:'从事律师行业多年...',target:[1]},
    {_id:2,name:'李四',contact:'13333333334',description:'介绍一下自己...',target:[1,4]},
    {_id:3,name:'王五',contact:'13333333334',description:'介绍一下自己...',target:[2,4]},
    {_id:4,name:'赵六',contact:'13333333334',description:'介绍一下自己...',target:[4]},
